...
public enum FunctionalExceptionResponse {
    ...
    OWNER_NOT_AUTHORIZED_TO_CREATE_DISH("You are not authorized to create dishes for this restaurant"),
    OWNER_NOT_AUTHORIZED_TO_UPDATE_DISH("You are not authorized to modify dishes for this restaurant"),
