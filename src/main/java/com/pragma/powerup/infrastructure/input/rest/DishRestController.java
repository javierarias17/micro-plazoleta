...
public class DishRestController {
    ...
    @Operation(summary = "Update dish", description = "Updates the price and description of an existing dish. Only the owner of the restaurant can modify its dishes.")
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Dish not found",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(value = "{\"message\":\"Business validation failed\",\"errors\":[{\"field\":\"dishId\",\"message\":\"The dish does not exist\"}]}"))),
            @ApiResponse(responseCode = "400", description = "Invalid fields",
                    content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                            examples = @ExampleObject(value = "{\"message\":\"Validation failed\",\"errors\":[{\"field\":\"price\",\"message\":\"Price must be a positive number\"}]}"))),
            @ApiResponse(responseCode = "500", description = "Internal server error",
